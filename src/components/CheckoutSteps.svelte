...
<nav aria-label="Progress">
    <ol class="flex items-center bg-white pt-5 pb-10 px-14 w-full">
      <li class="relative pr-8 sm:pr-20 w-[320px]">
        <div class="absolute inset-0 flex items-center" aria-hidden="true">
          <div class="h-0.5 w-full bg-green-700"></div>
        </div>
        <a href="/" class="relative w-8 text-green-700 h-8 flex items-center justify-center bg-green-700 rounded-full hover:bg-green-900">
          <svg class="w-5 h-5 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
          </svg>
          <span class="self-end font-bold absolute top-10">DELIVERY</span>
        </a>
      </li>
      ...
      <li class="relative pr-8 sm:pr-20 w-[320px]">
        ...
        <a href="/" class="relative w-8 text-green-700 h-8 flex items-center justify-center bg-green-700 rounded-full hover:bg-green-900">
          ...
          <span class="self-end font-bold absolute top-10">PAYMENT</span>
        </a>
      </li>
      ...
      <li class="relative pr-8 sm:pr-20">
        ...
        <a href="/" class="relative w-8 text-green-700 h-8 flex items-center justify-center bg-green-700 rounded-full hover:bg-green-900">
          ...
          <span class="self-end font-bold absolute top-10">SUMMARY</span>
        </a>
      </li>
